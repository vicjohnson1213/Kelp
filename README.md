...
```bash
source /dev/stdin <<< "$(curl -o- https://raw.githubusercontent.com/vicjohnson1213/Kelp/master/install)"
```

or Wget:

```bash
source /dev/stdin <<< "$(wget -qO- https://raw.githubusercontent.com/vicjohnson1213/Kelp/master/install)"
```
